...
const FAQ_ITEMS = [
  {
    ...
    answer:
      "FundingPro — AI-платформа для поиска грантов, стипендий и программ, проверки соответствия требованиям и подготовки заявок. Сейчас платформа ориентирована на физических лиц в Узбекистане и Центральной Азии.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Тарифы начинаются от 384 000 UZS в месяц для физических лиц. Подробности — на главной странице и в разделе подписки после входа. Оплата через Uzum Bank.",
  },
];
