...
export const metadata: Metadata = {
  ...
  description:
    "Как FundingPro помогает бизнесу и молодёжи находить гранты и стипендии, проверять соответствие требованиям донора и готовить заявку с помощью AI.",
...
const FAQ_ITEMS = [
  {
    ...
    answer:
      "FundingPro — AI-платформа для поиска грантов, стипендий и программ, проверки соответствия требованиям и подготовки заявок. Платформа ориентирована на бизнес и молодёжь в Узбекистане и Центральной Азии.",
  },
  {
    question: "Как найти подходящий грант?",
    answer:
      "Зарегистрируйтесь, заполните личный профиль и воспользуйтесь каталогом грантов с фильтрами по сектору, стране и дедлайну. AI подберёт Top 10 возможностей с наибольшим совпадением по вашему профилю.",
  },
  {
    question: "Как работает AI-проверка соответствия?",
    answer:
      "Система анализирует требования донора и ваш личный профиль, указывает на пробелы в документах и даёт рекомендации по улучшению заявки. Персональные данные обрабатываются с соблюдением политики конфиденциальности.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Тарифы начинаются от 384 000 UZS в месяц. Подробности — на главной странице и в разделе подписки после входа. Оплата через Uzum Bank.",
  },
];
