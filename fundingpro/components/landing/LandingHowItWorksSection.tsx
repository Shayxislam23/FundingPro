...
const STEPS = [
  { step: "1", title: "Личный профиль", desc: "Укажите интересы и опыт — AI подберёт релевантные возможности." },
  { step: "2", title: "Проверка соответствия", desc: "Узнайте, насколько вы подходите требованиям донора или программы." },
