...
const SLIDES = [
  {
    ...
    title: "Найдите грант",
    description: "Каталог доноров, дедлайны и фильтры по секторам для НКО в Узбекистане.",
  },
  {
    icon: "checkmark-circle" as const,
    title: "Проверьте соответствие",
    description: "Узнайте, подходит ли вашей организации грант, до подачи заявки.",
  },
  {
